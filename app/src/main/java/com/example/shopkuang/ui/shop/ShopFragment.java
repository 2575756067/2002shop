package com.example.shopkuang.ui.shop;
...
import com.example.shopkuang.shoppingcar.PayMentActivity;
...
import com.example.shopkuang.shoppingcar.presenter.CarPresenter;
...
public class ShopFragment extends BaseFragment<ICarHome.Presenter> implements ICarHome.View,View.OnClickListener {
    ...
    @Override
    protected ICarHome.Presenter createPrenter() {
